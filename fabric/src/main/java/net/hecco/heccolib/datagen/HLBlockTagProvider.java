...
//                    .add(BlockFamilyCreator.BLOCKS.get(name + "_log"))
//                    .add(BlockFamilyCreator.BLOCKS.get(name + "_wood"))
//                    .add(BlockFamilyCreator.BLOCKS.get("stripped_" + name + "_log"))
//                    .add(BlockFamilyCreator.BLOCKS.get("stripped_" + name + "_wood"))
//            ;
