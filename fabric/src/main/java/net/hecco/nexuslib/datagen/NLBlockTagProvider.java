...
public abstract class NLBlockTagProvider extends FabricTagProvider.BlockTagProvider {

    private final String MOD_ID;

    public NLBlockTagProvider(String modId, FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
